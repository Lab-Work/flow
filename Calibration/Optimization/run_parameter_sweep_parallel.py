"""
input: a vector, b vector, num_sims_per_point
desired output: N sims running parallely {N-> number of cores}
"""
...
folder_path = '/Users/sshanto/summer_2020/vu/flow/Calibration/Optimization/Parallel'
